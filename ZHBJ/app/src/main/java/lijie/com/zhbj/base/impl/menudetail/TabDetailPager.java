package lijie.com.zhbj.base.impl.menudetail;
...
import lijie.com.zhbj.NewsDetailActivity;
import lijie.com.zhbj.R;
import lijie.com.zhbj.base.BaseMenuDetailPager;
import lijie.com.zhbj.domain.NewsBean;
import lijie.com.zhbj.domain.TabDetailBean;
import lijie.com.zhbj.global.GlobalContants;
import lijie.com.zhbj.utils.CacheUtils;
import lijie.com.zhbj.utils.SharePreferenceUtils;
import lijie.com.zhbj.view.HorizontalScrollViewPager;
import lijie.com.zhbj.view.RefreshListView;
...
public class TabDetailPager extends BaseMenuDetailPager implements
	...
	NewsBean.NewsMenuTab mNewsTab;// 页签数据
	...
	private ArrayList<TabDetailBean.News> mNewsList;// 列表新闻数据
	...
	public TabDetailPager(Activity activity, NewsBean.NewsMenuTab newsTab) {
		super(activity);
		mNewsTab = newsTab;
	...
	public View initView() {
		...
		lvList.setOnRefreshListener(new RefreshListView.RefreshListener() {
		 ...
		 * 设置Item点击监听
		 */
		lvList.setOnPullItemClickListener(this);
	...
	protected void processData(String result, boolean more) {
		...
		if (!more) {// 不加载更多
			...
			ArrayList<TabDetailBean.News> news = tabInfo.data.news;
			if (mNewsList != null) {
