...
public class NewsMenuDetailPager extends BaseMenuDetailPager implements
	...
	private ArrayList<NewsBean.NewsMenuTab> mNewsTabDataList;// 页签对应的数据
	private ArrayList<TabDetailPager> mNewsTabPagerList;// 页签对应的页面列表

	private NewsMenuAdapter mAdapter;

	public NewsMenuDetailPager(Activity activity, NewsBean.NewsMenuBean newsMenuBean) {
		super(activity);
	...
	public void initData() {
		...
		// 初始化页签页面列表
		for (NewsBean.NewsMenuTab newsTab : mNewsTabDataList) {
